...
public class ButtonBindings {
    ...
    public void initGunnerBindings() {
        ...
        mGunnerController.rightTrigger()
            .whileTrue(mConveyorSS.setConveyorStateCmd(ConveyorState.INTAKE).alongWith(mShooter.setFuelPumpStateCmd(FuelPumpState.INTAKE)).alongWith(mIntakeSS.trashCompact()))
