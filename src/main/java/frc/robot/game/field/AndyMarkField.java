...
public final class AndyMarkField implements FieldDimensions {
  // FIELD
  private static final double kFieldXIn = 650.12;
  private static final double kFieldYIn = 316.64;

  private static final double kStartingLineXIn = 156.06 + 1; // Added 1 to get it on the very center of the starting line
  private static final double kOutpostCenterYIn = 25.62;

  // HUB
  private static final double kHubXIn = 181.56;
