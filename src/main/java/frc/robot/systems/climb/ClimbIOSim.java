...
public class ClimbIOSim implements ClimbIO{
    ...
    public ClimbIOSim(BasicMotorHardware pConfig, ElevatorController pController) {
        ...
        mClimbMotor = new DCMotorSim(
            LinearSystemId.createDCMotorSystem(DCMotor.getKrakenX44(1), 0.004, mConfig.rotorToMechanismRatio()),
        ...
        mClimbPID = new PIDController(mController.pdController().kP(), 0.0, mController.pdController().kD());
    }
